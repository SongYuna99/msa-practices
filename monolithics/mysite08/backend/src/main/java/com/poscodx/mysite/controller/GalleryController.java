...
public class GalleryController {
	...
	public ResponseEntity<?> create(MultipartFile file, GalleryVo galleryVo) {
		...
		try {
			...
			Map<String, String> responseUpload = restTemplate.postForObject("http://service-storage/", requestEntity,
					Map.class);
	...
	public ResponseEntity<?> delete(@PathVariable("no") Long no) {
		...
		ResponseEntity<?> response = restTemplate.exchange(String.format("http://service-gallery/%d", no),
